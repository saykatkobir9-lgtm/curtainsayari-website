...
`,n)!==-1&&!e.endsWith(`
`)?`${e}
$$`:`${e}$$`},yr=e=>{let t=0,n=0;for(let o=0;o<e.length;o+=1)e[o]==="*"?n+=1:(n>=3&&(t+=Math.floor(n/3)),n=0);return n>=3&&(t+=Math.floor(n/3)),t},wr=e=>{if(ge(e)||or.test(e))return e;let t=e.match(Go);if(t){let n=t[2];if(!n||_.test(n))return e;if(yr(e)%2===1)return `${e}***`}return e},Fe=e=>{if(!e||typeof e!="string")return e;let t=e,n=ir(t);return n.endsWith("](streamdown:incomplete-link)")?n:(t=n,t=wr(t),t=ar(t),t=lr(t),t=dr(t),t=fr(t),t=hr(t),t=gr(t),t=br(t),t)};var Sr={harden:[rehypeHarden.harden,{allowedImagePrefixes:["*"],allowedLinkPrefixes:["*"],defaultOrigin:void 0,allowDataImages:true}],raw:xr__default.default,katex:[Ve__default.default,{errorColor:"var(--color-muted-foreground)"}]},Ar={gfm:[Ir__default.default,{}],math:[We__default.default,{singleDollarTextMath:false}],cjkFriendly:[Tr__default.default,{}],cjkFriendlyGfmStrikethrough:[Nr__default.default,{}]},Er=Object.values(Sr),Lr=Object.values(Ar),Br={shikiTheme:["github-light","github-dark"],controls:true,isAnimating:false,mode:"streaming",mermaid:void 0},P=react.createContext(Br),bn=react.memo(({content:e,shouldParseIncompleteMarkdown:t,...n})=>{let o=react.useMemo(()=>typeof e=="string"&&t?Fe(e.trim()):e,[e,t]);return jsxRuntime.jsx(He,{...n,children:o})},(e,t)=>{if(e.content!==t.content||e.shouldParseIncompleteMarkdown!==t.shouldParseIncompleteMarkdown||e.index!==t.index)return  false;if(e.components!==t.components){let n=Object.keys(e.components||{}),o=Object.keys(t.components||{});if(n.length!==o.length||n.some(r=>{var s,a;return ((s=e.components)==null?void 0:s[r])!==((a=t.components)==null?void 0:a[r])}))return  false}return !(e.rehypePlugins!==t.rehypePlugins||e.remarkPlugins!==t.remarkPlugins)});bn.displayName="Block";var Rr=["github-light","github-dark"],Dr=react.memo(({children:e,mode:t="streaming",parseIncompleteMarkdown:n=true,components:o,rehypePlugins:r=Er,remarkPlugins:s=Lr,className:a,shikiTheme:i=Rr,mermaid:l,controls:c=true,isAnimating:d=false,BlockComponent:m=bn,parseMarkdownIntoBlocksFn:f=qe,...h})=>{let u=react.useId(),[g,w]=react.useTransition(),[k,x]=react.useState([]),N=react.useMemo(()=>f(typeof e=="string"?e:""),[e,f]);react.useEffect(()=>{t==="streaming"?w(()=>{x(N);}):x(N);},[N,t]);let T=t==="streaming"?k:N,B=react.useMemo(()=>T.map((H,L)=>`${u}-${L}`),[T.length,u]),O=react.useMemo(()=>({shikiTheme:i,controls:c,isAnimating:d,mode:t,mermaid:l}),[i,c,d,t,l]),F=react.useMemo(()=>({...Ut,...o}),[o]);return react.useEffect(()=>{if(!(Array.isArray(r)&&r.some(S=>Array.isArray(S)?S[0]===Ve__default.default:S===Ve__default.default)))return;let L=false;if(Array.isArray(s)){let S=s.find(ne=>Array.isArray(ne)?ne[0]===We__default.default:ne===We__default.default);S&&Array.isArray(S)&&S[1]&&(L=S[1].singleDollarTextMath===true);}let R=typeof e=="string"?e:"",z=R.includes("$$"),y=L&&(/[^$]\$[^$]/.test(R)||/^\$[^$]/.test(R)||/[^$]\$$/.test(R));(z||y)&&import('katex/dist/katex.min.css');},[r,s,e]),t==="static"?jsxRuntime.jsx(P.Provider,{value:O,children:jsxRuntime.jsx("div",{className:p("space-y-4",a),children:jsxRuntime.jsx(He,{components:F,rehypePlugins:r,remarkPlugins:s,...h,children:e})})}):jsxRuntime.jsx(P.Provider,{value:O,children:jsxRuntime.jsx("div",{className:p("space-y-4",a),children:T.map((H,L)=>jsxRuntime.jsx(m,{components:F,content:H,index:L,rehypePlugins:r,remarkPlugins:s,shouldParseIncompleteMarkdown:n,...h},B[L]))})})},(e,t)=>e.children===t.children&&e.shikiTheme===t.shikiTheme&&e.isAnimating===t.isAnimating&&e.mode===t.mode);Dr.displayName="Streamdown";var vn=({children:e,className:t,minZoom:n=.5,maxZoom:o=3,zoomStep:r=.1,showControls:s=true,initialZoom:a=1,fullscreen:i=false})=>{let l=react.useRef(null),c=react.useRef(null),[d,m]=react.useState(a),[f,h]=react.useState({x:0,y:0}),[u,g]=react.useState(false),[w,k]=react.useState({x:0,y:0}),[x,N]=react.useState({x:0,y:0}),T=react.useCallback(y=>{m(I=>Math.max(n,Math.min(o,I+y)));},[n,o]),B=react.useCallback(()=>{T(r);},[T,r]),O=react.useCallback(()=>{T(-r);},[T,r]),F=react.useCallback(()=>{m(a),h({x:0,y:0});},[a]),H=react.useCallback(y=>{y.preventDefault();let I=y.deltaY>0?-r:r;T(I);},[T,r]),L=react.useCallback(y=>{if(y.button!==0||y.isPrimary===false)return;g(true),k({x:y.clientX,y:y.clientY}),N(f);let I=y.currentTarget;I instanceof HTMLElement&&I.setPointerCapture(y.pointerId);},[f]),R=react.useCallback(y=>{if(!u)return;y.preventDefault();let I=y.clientX-w.x,S=y.clientY-w.y;h({x:x.x+I,y:x.y+S});},[u,w,x]),z=react.useCallback(y=>{g(false);let I=y.currentTarget;I instanceof HTMLElement&&I.releasePointerCapture(y.pointerId);},[]);return react.useEffect(()=>{let y=l.current;if(y)return y.addEventListener("wheel",H,{passive:false}),()=>{y.removeEventListener("wheel",H);}},[H]),react.useEffect(()=>{let y=c.current;if(y&&u)return document.body.style.userSelect="none",y.addEventListener("pointermove",R,{passive:false}),y.addEventListener("pointerup",z),y.addEventListener("pointercancel",z),()=>{document.body.style.userSelect="",y.removeEventListener("pointermove",R),y.removeEventListener("pointerup",z),y.removeEventListener("pointercancel",z);}},[u,R,z]),jsxRuntime.jsxs("div",{className:p("relative",i?"h-full w-full":"w-full",t),ref:l,style:{cursor:u?"grabbing":"grab"},children:[s&&jsxRuntime.jsxs("div",{className:p("absolute z-10 flex flex-col gap-1 rounded-md border border-border bg-background/90 p-1 shadow-sm backdrop-blur-sm",i?"bottom-4 left-4":"bottom-2 left-2"),children:[jsxRuntime.jsx("button",{className:"flex items-center justify-center rounded p-1.5 text-muted-foreground transition-colors hover:bg-muted hover:text-foreground disabled:cursor-not-allowed disabled:opacity-50",disabled:d>=o,onClick:B,title:"Zoom in",type:"button",children:jsxRuntime.jsx(lucideReact.ZoomInIcon,{size:16})}),jsxRuntime.jsx("button",{className:"flex items-center justify-center rounded p-1.5 text-muted-foreground transition-colors hover:bg-muted hover:text-foreground disabled:cursor-not-allowed disabled:opacity-50",disabled:d<=n,onClick:O,title:"Zoom out",type:"button",children:jsxRuntime.jsx(lucideReact.ZoomOutIcon,{size:16})}),jsxRuntime.jsx("button",{className:"flex items-center justify-center rounded p-1.5 text-muted-foreground transition-colors hover:bg-muted hover:text-foreground",onClick:F,title:"Reset zoom and pan",type:"button",children:jsxRuntime.jsx(lucideReact.RotateCcwIcon,{size:16})})]}),jsxRuntime.jsx("div",{className:p("origin-center transition-transform duration-150 ease-out",i&&"flex h-full w-full items-center justify-center"),onPointerDown:L,ref:c,role:"application",style:{transform:`translate(${f.x}px, ${f.y}px) scale(${d})`,transformOrigin:"center center",touchAction:"none",willChange:"transform"},children:e})]})};var rt=({chart:e,className:t,config:n,fullscreen:o=false})=>{let[r,s]=react.useState(null),[a,i]=react.useState(true),[l,c]=react.useState(""),[d,m]=react.useState(""),[f,h]=react.useState(0),{mermaid:u}=react.useContext(P),g=u==null?void 0:u.errorComponent;if(react.useEffect(()=>{(async()=>{try{s(null),i(!0);let x=await se(n),N=e.split("").reduce((O,F)=>(O<<5)-O+F.charCodeAt(0)|0,0),T=`mermaid-${Math.abs(N)}-${Date.now()}-${Math.random().toString(36).substring(2,9)}`,{svg:B}=await x.render(T,e);c(B),m(B);}catch(x){if(!(d||l)){let N=x instanceof Error?x.message:"Failed to render Mermaid chart";s(N);}}finally{i(false);}})();},[e,n,f]),a&&!l&&!d)return jsxRuntime.jsx("div",{className:p("my-4 flex justify-center p-4",t),children:jsxRuntime.jsxs("div",{className:"flex items-center space-x-2 text-muted-foreground",children:[jsxRuntime.jsx("div",{className:"h-4 w-4 animate-spin rounded-full border-current border-b-2"}),jsxRuntime.jsx("span",{className:"text-sm",children:"Loading diagram..."})]})});if(r&&!l&&!d){let k=()=>h(x=>x+1);return g?jsxRuntime.jsx(g,{chart:e,error:r,retry:k}):jsxRuntime.jsxs("div",{className:p("rounded-lg border border-red-200 bg-red-50 p-4",t),children:[jsxRuntime.jsxs("p",{className:"font-mono text-red-700 text-sm",children:["Mermaid Error: ",r]}),jsxRuntime.jsxs("details",{className:"mt-2",children:[jsxRuntime.jsx("summary",{className:"cursor-pointer text-red-600 text-xs",children:"Show Code"}),jsxRuntime.jsx("pre",{className:"mt-2 overflow-x-auto rounded bg-red-100 p-2 text-red-800 text-xs",children:e})]})]})}let w=l||d;return jsxRuntime.jsx(vn,{className:p(o?"h-full w-full overflow-hidden":"my-4 overflow-hidden",t),fullscreen:o,maxZoom:3,minZoom:.5,showControls:true,zoomStep:.1,children:jsxRuntime.jsx("div",{"aria-label":"Mermaid chart",className:p("flex justify-center",o&&"h-full w-full items-center"),dangerouslySetInnerHTML:{__html:w},role:"img"})})};exports.a=p;exports.b=Rn;exports.c=rt;exports.d=qe;exports.e=Fe;exports.f=Sr;exports.g=Ar;exports.h=P;exports.i=bn;exports.j=Dr;